...
class ColorWheel: UIView {
    ...
    override func layoutSubviews() {
        ...
        brightnessLayer.path = UIBezierPath(roundedRect: CGRect(x: 20, y: 20, width: self.frame.width-40, height: self.frame.height-40), cornerRadius: (self.frame.height-40)/2).cgPath
